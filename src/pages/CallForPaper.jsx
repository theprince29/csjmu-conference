  ...
  return (
    <div className="bg-gray-100 text-left p-6 ">
      ...
      <div className="space-y-4">
        ...
        <div className="text-lg text-gray-700 m-2 text-justify">
International Conference on Recent Advances in Emerging Computing and Communication Technologies (ICRAECCT-2025) brings together global
 experts to discuss advancements in fields like AI, IoT, 5G and machine learning. This conference emphasizes the role of emerging technologies 
 in reshaping industries, enhancing operational efficiency, and tackling real-world challenges. Participants, including researchers, practitioners, and industry professionals, will explore breakthroughs in data security, network reliability, and computational scalability—essential aspects for next-generation solutions in sectors such as healthcare, finance, and urban infrastructure. In addition to technical sessions and workshops, the conference encourages interdisciplinary collaborations, aiming to develop technology that is both impactful and ethically sound. Attendees will gain insights into the social implications of technological advancements, fostering discussions that look beyond theoretical achievements to prioritize accessible, real-world applications. This conference is designed to facilitate networking, innovation, and actionable knowledge-sharing, setting the foundation for future advancements in computing and communication.
  <p>
    Organizers encourage to submit papers on inter-disciplinary fields such as Role of Artificial Intelligence, Machine Learning, Emerging computing and communication technologies in different areas involving education, healthcare, management, business, agriculture and so on. 
    </p> 
        </div>
      ...
      <p className="text-xl font-semibold mb-4">Submissions are invited on following Tracks but are not limited to:</p>
      <p>
     <ul>
      <li className="text-200 font-semibold ">
        TRACK 1: ARTIFICIAL INTELLIGENCE, MACHINE LEARNING AND DEEP LEARNING
        </li> 
  <li>
 ...
 <li className="mb-4"> Human-Computer Interaction (HCI) And Augmented/Virtual Reality (AR/VR)</li>
</ul>

 <ul>
 <li className="text-200 font-semibold "> TRACK 2: DATA SCIENCE AND BIG DATA ANALYTICS</li>
<li> Data Grids, Data Warehousing, OLAP</li>
<li> Temporal, Spatial, and Multimedia databases</li>
<li> Mathematical, probabilistic and statistical models and theories</li>
...
<li> Data Integration, Interoperability and Metadata for Cross-media data analytics</li>
<li> Ubiquitous Data Management and Mobile Databases</li>
<li> Query processing, query optimization, and data structures</li>
...
<li className="mb-4">  Scientific and Biological Databases and Bioinformatics</li>
  </ul> 
...
TRACK 5: HARDWARE ARCHITECTURE AND EMERGING TECHNOLOGIES IN COMMUNICATION SYSTEMS
  </li>

<li>5G/6G Networks and Wireless Technologies</li>
<li>Antenna Design</li>
<li>Network Function Virtualization (NFV) snd Software-Defined Networking (SDN)</li>
<li>Quantum Computing and Quantum Communication</li>
<li>Edge and Fog Computing</li>
<li>High-Performance Computing (HPC) and Parallel Processing</li>
<li>Federated Learning</li>
<li>Cloud Computing</li>
<li className="mb-4">Process Monitoring, Reliability & Fault tolerance, Embedded Software and Hardware Architecture Techniques.</li>
</ul>
...
<li>Semantic Interoperability in the IoT, WoT and Open-Source Solutions </li> 
<li>IoT Enabling Technologies and its Applications </li> 
<li>IoT Multimedia, Societal Impacts and Sustainable Development </li> 
...
<li>Database, applications and web security </li> 
</ul>
<ul>
<li className="text-200 font-semibold mt-4">
...
<li>Advanced and multidimensional networks (including WSNs, MANETs, VANETs, P2P) </li> 
...
<li className="text-justify">The papers submitted to the conference will be peer-reviewed and published as SCOPUS indexed proceedings. </li> 

 <li className="text-justify"> All papers will undergo a single-blind peer-review process, and all accepted papers will be published in the SCOPUS-indexed conference proceedings. The conference organizers encourage the submission of academic and research papers that address multidisciplinary and interdisciplinary themes, encompassing Management, Science, Engineering, Agriculture, Healthcare, and Social Studies, through one of the specified sub-themes. Submissions on other relevant topics are also welcome for consideration. </li> 
</ul>
      </p>
    </div>
  );
