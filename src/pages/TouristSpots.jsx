...
function TouristSpots() {
  return (
    <>
      ...
      <Helmet>
        <title>Attractions Nearby - ICRAECCT'2025 Conference</title>
        <meta name="description" content="Discover top tourist spots near the ICRAECCT 2025 Conference location. Plan your visit to Agra, Varanasi, Prayagraj, and more – popular cultural, spiritual, and historical attractions. Make the most of your trip by exploring these must-see destinations during the conference!" />
        <meta name="keywords" content="ICRAECCT 2025 Conference, Nearby tourist attractions for ICRAECCT attendees, Best places to visit near ICRAECCT 2025, Agra tourist spots, Varanasi attractions, Spiritual destinations India, Must-see places in Uttar Pradesh, Historical sites near ICRAECCT 2025, India cultural and spiritual tourism, ICRAECCT tourism guide 2025, Best pilgrimage spots in India" />
        <meta property="og:title" content="Tourist Attractions Near You" />
        <meta property="og:description" content="Explore the best tourist attractions in India including Agra, Varanasi, Prayagraj, and more!" />
      </Helmet>
      <h1 className="text-4xl font-bold text-third mb-8">ATTRACTION NEARBY</h1>
      </div>
      <div className='flex justify-evenly flex-wrap'>
        <Card images={"/images/taj.png"} title="Agar" desc = "The Taj Mahal in Agra, India, is a white marble mausoleum built by Emperor Shah Jahan in 1653 in memory of his wife, Mumtaz Mahal. Renowned for its beauty and symmetry, it symbolizes eternal love and blends Islamic, Persian, and Indian..." />{/* architectural styles. A UNESCO World Heritage Site, it attracts millions of visitors each year. */}
