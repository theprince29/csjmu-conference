...
const SpeakerCard = ({ name, title, description, image }) => {
  ...
  const speakers = [
    ...
    },
    {
      ...
      title: "NIT Raipur",
      description: "Enlisted in Global AD (Alper-Doger) Scientific Index 2024 list. Ranked within the 'Top 2% Global Scientists/Researchers in the World' (Published by Elsevier, on October 4, 2023)",
