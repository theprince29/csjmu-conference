  ...
  return (
    <div className="bg-gray-100 text-left p-6 md:p-12 lg:p-16">
      ...
      <ul className=" list-disc space-y-2 text-gray-700 text-left">
        ...
        <li>
          Prof. Neelendra Badal, Director, Rajkiya Engineering College, Bijnor
          (UP), India
        </li>
        <li>
          Prof. Vikram Bali, Director, Galgotias College of Engineering &
          Technology (GCET), Gr. Noida (UP), India
        </li>
        <li>
          Prof. Shivani Bali, Professor-Business Analytics, Jaipuria Institute
          of Management, Noida (UP), India
        </li>
        <li>
          Prof. Sumit Kumar, Dept. of CSE, ASET, Amity University, Noida (UP),
          India
        </li>
        <li>
          Prof. Laxmi Ahuja, Dept. of IT, AIIT, Amity University, Noida (UP),
          India
        </li>
        <li>Prof. Praveen Gupta, Director, LBSIM, New Delhi, India</li>
        <li>Prof. Rekha Gupta, Professor-IT, LBSIM, New Delhi, India</li>
        <li>
          Prof. Sachin Ahuja, Executive Director - Engineering, Chandigarh
          University, Chandigarh, India
        </li>
        <li>Prof. K. K. Goyal, Dean-MCA, RBSMTC, Khandari, Agra (UP), India</li>
        <li>
          Prof. Pankaj Saxena, Professor-MCA, RBSMTC, Khandari, Agra (UP), India
        </li>
        <li>
          Prof. Adesh Kr. Pandey, Dean & Professor-IT, KIET, Ghaziabad (UP),
          India
        </li>
        <li>
          {" "}
          Prof. Vineet Sharma, Dean & Professor-CSE, KIET, Ghaziabad (UP), India
        </li>
        <li>
          Prof. Raghav Mehra, Dept. of CSE, Chandigarh University, Chandigarh,
          India
        </li>
        <li>
          Prof. Charu Pathak, Dept. of Electronics & Communication, Manav Rachna
          University, Faridabad, Haryana, India
        </li>
        <li>
          Prof. Suneet Gupta, SCSE, Galgotias University, Gr. Noida (UP), India
        </li>
        <li>
          Prof. Anu Chaudhary, Head-Dept. of IT, AKGEC, Ghaziabad (UP), India
        </li>
        <li>Prof. M. N. Hoda, Director, BVICAM, New Delhi, India</li>
        <li>
          Prof. Gur Saran, Professor, Dayalbagh Educational Institute (DEI),
          Dayalbagh, Agra (UP), India
        </li>
        <li>Prof. Arun Sharma, Dean-Academics, IGDTUW, New Delhi, India</li>
        <li>
          Prof. R. K. Singh, Professor, Dept. of IT & Dean (Students' Welfare),
          IGDTUW, New Delhi, India
        </li>
        <li>
          Prof. Amar K. Mohapatra, Head-Department of IT, IGDTUW, New Delhi,
          India
        </li>
        <li>Prof. M. U. Bokhari, Dept. of CS, AMU, Aligarh (UP), India</li>
        <li>
          Prof. Vinay Rishiwal, Professor, Dept. of CSIT, MJP Rohilkhand
          University, Bareilly (UP), India
        </li>
        <li>
          Prof. Vrijendra Singh, Professor, Dept. of IT, IIIT-Allahabad (UP),
          India
        </li>
        <li>
          Prof. D. P. Mohapatra, Professor, Dept. of CSE, NIT Rourkela, Odisha,
          India
        </li>
        <li>
          Prof. Abhay Bansal, Dean, Engineering (SCSET & SEAS) & Dean (IRCO),
          Bennett University, Greater Noida (UP), India
        </li>
        <li>Prof. Sanjeev Kumar, Professor, SCS, UPES, Dehradun</li>
        ...
        <li>Prof. (Dr.) Manoj Kumar Shukla, HBTU, Kanpur</li>
        <li>
          Prof. (Dr.) Ajai Jain, Institute of Engineering and Technology, JK
          Lakshmipat University, Jaipur.
        </li>
        <li>
          Prof. (Dr.) Renu Jain, Institute of Engineering and Technology, JK
          Lakshmipat University, Jaipur.
        </li>
        <li>
          Prof. (Dr.) R. K. Dwivedi, Director, Teerthanker Mahaveer University,
          Moradabad
        </li>
        <li>
          Prof. (Dr.) Brijesh Kumar, Professor & Director (Planning), Indira
          Gandhi Delhi Technical University For Women, Delhi
        </li>
        <li>
          Prof. R. P. Mahapatra, SRMIST, Delhi-NCR Campus, Ghaziabad (UP), India
        </li>
        <li>
          Prof. Jagadeesh G., Professor, Software & Systems Engineering,
          SCSE&IS, VIT, Vellore, Tamil Nadu, India
        </li>
        <li>
          Dr. Ravindra Nath Katiyar, Baba Saheb Bhimrao Ambedkar University,
          Lucknow (A Central University)
        </li>
        <li>
          Prof. A. Senthil, K L University, Vaddeswaram, Andhra Pradesh, India
        </li>
        <li>Prof. Shamik Tiwari, IILM University, Gurugram, Haryana, India</li>
        <li>
          Prof. Munish Khanna, Galgotias University, Greater Noida (UP), India
        </li>
        <li>Prof. Vishal Jain, Sharda University, Greater Noida (UP), India</li>
        <li>Prof. Sachin Gupta, MAIT, GGSIPU, New Delhi, India</li>
        <li>Prof. Abhishek Swaroop, BPIT, GGSIPU, New Delhi, India</li>
        <li>
          Prof. Karmeshu, Distinguished Professor, SCS, UPES, Dehradun and
          Ex-Professor, SCSS, JNU, New Delhi, India
        </li>
        <li>
          Prof. Adesh Kumar, University of Petroleum and Energy Studies,
          Dehradun
        </li>
        <li>Prof. Anurag Tripathi, IET Lucknow</li>
        <li>
          Prof. B. K. Sharma, Professor, Dept. of MCA, AKGEC, Ghaziabad (UP),
          India
        </li>
        <li>
          Prof. Pradeep Kumar Gupta, Mohan Babu University, Tirupati, Andhra
          Pradesh, India
        </li>
        <li>
          Prof. Sunil Kr. Pandey, Director (IT & UG), ITS, Ghaziabad, India
        </li>
        <li>
        ...
        <li>Dr. Sudhanshu Verma, MMMUT Gorakhpur</li>
        <li>
        ...
        <li>
          Dr. Shrawan Kumar, Indira Gandhi National Tribal University Regional
          Campus Manipur India
        </li>
        <li>
          Dr. Manoj Kumar Misra, Director, Allenhouse Institute of Technology,
          Kanpur
        </li>
        <li>
        ...
        <li>Dr. Ajay Narayan Shukla, Graphic Era Hill University, Dehradun</li>
        ...
        <li>Dr Shailendra Kumar, Integral University, Lucknow</li>
        <li>Dr. Siddharth Singh, University of Lucknow, Lucknow</li>
        <li>Dr. Zeeshan Ali Siddiqui, University of Lucknow, Lucknow</li>
        ...
        <li>Dr. Himanshu Katiyar, Rajkiya Engineering College Sonbhadra</li>
        <li>Dr. Monica Mehrotra, Director, B.B.D. ESGI Lucknow</li>
        <li>
          Dr. Bhupendra Singh, Scientist, Secure Syatems Division, CAIR, DRDO,
          Bengaluru, India
        </li>
        <li>
          Dr. Ashish Dubey, Sr. Scientist - DMSRDE, DRDO, Kanpur (UP), India
        </li>
        <li>
          Dr. Biswajit Saha, Director (Trainings & Skill Education), CBSE, New
          Delhi, India
        </li>
        <li>
          Dr. Atul Chaturvedi, Dy. Director, Allenhouse Institute of Technology
          (AIT), Rooma, India
        </li>
        <li>S.H. Abbas Mehdi, Dy. Director, STPI, Indore (MP), India</li>
        <li>Dr. Himanshu Mittal, IGDTUW, New Delhi, India</li>
        <li>Dr. Shekhar Shukla, IIM Indore, India</li>
        <li>Dr. Praveen Ranjan Srivastava, IIM Rohtak, India</li>
        <li>
          Dr. Rupali Bhardwaj, Thapar Institute of Engineering & Technology,
          Patiala, Punjab, India
        </li>
        <li>Dr. Karan Singh, SCSS, JNU, New Delhi, India</li>
        <li>Dr. Syed Imtiyaz Hassan, SCSIT, MANUU, Hyderabad, India</li>
        <li>Dr. Abhay Kumar Singh, IIT (ISM), Dhanbad, Jharkhand, India</li>
        <li>Dr. Uday Pratap Rao, NIT, Patna, Bihar, India</li>
        <li>Dr. Vivek Singh Verma, HBTU, Kanpur (UP), India</li>
        <li>Dr. B. B. Sagar, HBTU, Kanpur (UP), India</li>
        <li>
          Dr. Pradeep Kumar Singh, Central University of Jammu, J&K, India
        </li>
        <li>Dr. Nitish Pathak, BPIT, GGSIPU, New Delhi, India</li>
        <li>Dr. Ashish Khanna, MAIT, GGSIPU, New Delhi, India</li>
        <li>Dr. Chandramani Sharma, SCS, UPES, Dehradun (UK), India</li>
        <li>
          Dr. Arun Solanki, USICT, Gautam Buddha University (GBU), Gr. Noida
          (UP), India
        </li>
        <li>
          Dr. Pradeep Tomar, USICT, Gautam Buddha University (GBU), Gr. Noida
          (UP), India
        </li>
        <li>Dr. Alka Agrawal, BBAU, Lucknow (UP), India</li>
        <li>Dr. Neetu Gupta, AIIT, Amity University, Noida (UP), India</li>
        <li>
          Dr. Arnika Jain, Manav Rachna University, Faridabad, Haryana, India
        </li>
        <li>
          Dr. Avneesh Vashistha, SRMIST, Delhi-NCR Campus, Ghaziabad (UP), India
        </li>
        <li>
