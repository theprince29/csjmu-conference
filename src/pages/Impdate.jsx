        ...
        <table className="table-auto w-full text-left py-4 mb-8 bg-white border-collapse shadow-lg">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="px-4 py-4 border border-gray-300 text-base sm:text-lg"><span className='line-through text-red-500'>20 January  2025</span><br /><span className='line-through text-red-500'> 20 February 2025</span><br /><span className='line-through text-red-500'> 28 February 2025</span><br /><span>15 March 2025</span></td>
            </tr>
            <tr className='bg-gray-200'>
              <td className="px-4 py-4 border border-gray-300 text-base sm:text-lg">Notification of Acceptance:</td>
              <td className="px-4 py-4 border border-gray-300 text-base sm:text-lg"><span className='line-through text-red-500'>15 February  2025</span><br /><span className='line-through text-red-500'> 28 February 2025</span><br /><span className='line-through text-red-500'>10 March 2025</span><br /><span>20 March 2025</span></td>
            </tr>
            <tr>
