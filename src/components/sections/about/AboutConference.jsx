      ...
      <div className="text-md text-gray-700 text-justify">
        ...
        <p className="mb-2">
          ...
          <strong><em> International Conference on Recent Advances in Emerging Computing and Communication
            Technologies (IC-RAECCT 2025) </em></strong> in association with  <em>Aurel Vlaicu University of Arad, Romania</em>, to be held on April 11th-12th, 2025, at our campus.
        </p>
